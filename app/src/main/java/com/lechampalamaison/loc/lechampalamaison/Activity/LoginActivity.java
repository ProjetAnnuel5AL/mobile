...
public class LoginActivity extends AppCompatActivity {
    ...
    public static final String CalendarOption = "calKey";
    public static final String NotifiOption = "NotifKey";
    public static final String FCMOption = "FcmKey";
    public static final String VersionBdOption = "VersionBdKey";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        editor.putBoolean(NotifiOption, true);
        editor.putBoolean(FCMOption, false);
        editor.putBoolean(FirstUpdateOption, false);
        editor.commit();
    ...
    public void login() {
        ...
        call.enqueue(new Callback<AuthResponse>() {
            ...
            public void onFailure(Call<AuthResponse> call, Throwable t) {
                Toast.makeText(LoginActivity.this, "Impossible de se connecter à internet. Merci de vérifier votre connexion.",
